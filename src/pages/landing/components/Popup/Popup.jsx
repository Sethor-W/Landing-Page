...
export default function Popup({children, active, handleDesactive}) {
  ...
  return (
    <div
        className={`fixed top-0 z-50 ${active ? 'flex items-center justify-center' : 'hidden'} w-full p-4 md:px-28 xl:px-40 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%)] max-h-full bg-black/[.5]`}
    >
