    ...
    <>
        <nav class="fixed bg-principals backdrop-blur w-full z-20 top-0 left-0 rounded-2xl mt-0">
            <div class="max-w-screen-xl flex flex-wrap md:flex-nowrap md:gap-14 items-center justify-between mx-auto py-4">
                <Link to={"/"} smooth={true} class="flex items-center">
                ...
                <div class="flex md:order-2">
                    <Link to='form' smooth={true} type="button" class="btn draw-border flex items-center text-white hover:text-gray-100 border-2 bg-[#4c2882]  focus:ring-4 focus:outline-none focus:bg-purple-800  font-medium rounded-lg text-base px-4 py-2 text-center mr-3 md:mr-0 dark:bg-purple-800 dark:hover:bg-[#4c2882] dark:focus:ring-purple-800 ">Unirse</Link>
                ...
                <div class={`items-center justify-between ${!active && 'hidden'} overflow-hidden transition-all duration-300 basis-full grow w-full md:flex md:w-auto md:order-1`} id="navbar-sticky">
                    ...
                    {links.map(({link, label}) => (
                        <li key={label}>
                        <Link to={link}  smooth={true} offset={-100} class="block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#d9eafe] md:p-0 md:dark:hover:text-violet-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{label}</Link> 
