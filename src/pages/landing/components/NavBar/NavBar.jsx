        ...
        <nav class="bg-principal fixed w-full z-20 top-0 left-0">
            <div class="max-w-screen-xl flex flex-wrap md:flex-nowrap md:gap-14 items-center justify-between mx-auto py-4">
                ...
                <div class="flex md:order-2">
                    <a href='#form' type="button" class="flex items-center text-white border-2 border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Unirse</a>
