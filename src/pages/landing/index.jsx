...
export default function Landing() {
  ...
  return (
    <div>
      ...
      <main className="">
        <section id='home' className='section1 body text-2xl mt-16 text-center md:text-left md:text-4xl grid grid-rows-1 md:grid-cols-2 justify-center items-center gap-4 '>
          <article className=''>
        ...
        <section id='form' className='section1 body grid-rows-3 text-2xl mt-16 flex flex-col gap-4 '>
