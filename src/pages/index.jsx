...
export default function Home() {
  ...
  return (
    <div>
      ...
      <main>
        <section className='bg-[url(/img/Hero-Background.png)] bg-top'>
          <section className='bg-gradient-section1-bg'>
            <NavBar />
            <div className='px-5 pt-5 bg-gradient-section1-b-t flex flex-col items-center justify-center gap-8 relative z-0 overflow-hidden'>
              <h1 className='text-4xl capitalize text-center'>pay with your face or  footprint Anytime Anywhere</h1>
              <p className='text-center text-[var(--letter-sub-color)]'>Welcome to Sethor. Where paying with your face or your footprint anywhere and anytime will no longer be a thing of the future!</p>
              <div className="options flex flex-row gap-3">
                <Link
                  className='text-black text-lg font-bold bg-[var(--background-button-action-rgb)] box-shadow-button-action py-4 px-7 rounded-2xl'
                  href={'#'}
                >
                  Join Waitlist
                </Link>
              ...
              <div class="relative">
                <img
                  className=" rotate-animation absolute inset-0 w-full h-full -z-[1]"
        ...
        <section className='px-5 py-20 bg-section2'>
          <div className=' flex flex-col items-start justify-center gap-8 relative z-0'>
            <h1 className='text-4xl capitalize text-left'>next hybrid application between a digital wallet and an e-commerce</h1>
            <p className='text-left text-[var(--letter-sub-color)]'>Where with us you will not have to add a payment method to buy or worry about not having a balance with which to pay.</p>
            <div className="options flex flex-row gap-3">
              <Link
                className='text-black text-lg font-bold bg-[var(--background-button-action-rgb)] box-shadow-button-action py-4 px-7 rounded-2xl'
                href={'#'}
        ...
        <section className='bg-[url(/img/Secion-3-Background.png)]'>
          <section className='px-5 py-[7.5rem] bg-gradient-section1-bg'>
            <div className='bg-black/50 rounded-[2rem] py-10 px-5 flex flex-col items-start justify-center gap-8 relative z-0'>
              <h1 className='text-4xl capitalize text-left'>Join our community now and get exclusive rewards on launch day!</h1>
              <p className='text-left text-[var(--letter-sub-color)]'>Just fill out the form and you'll be on our waiting list. By signing up, you'll be rewarded with early access to our app, plus gifts, points, and other surprises. Sign up now and be part of this exciting revolution!</p>
              <div className="options flex flex-row gap-3">
                <Link
                  className='text-black text-lg font-bold bg-[var(--background-button-action-rgb)] box-shadow-button-action py-4 px-7 rounded-2xl'
                  href={'#'}
        ...
        <footer className='bg-black px-5 py-12'>
          <div className='flex flex-col items-start justify-center gap-3'>
            <h1 className='text-4xl capitalize text-left'>Have an enquiry?</h1>
            <p className='text-left text-[var(--letter-sub-color)]'>If you have a general inquiry and would like to speak to our expert team, you can contact us via email at: info@sethor.tech</p>
            <Link
          ...
          <div className='flex flex-col items-start justify-center gap-10'>
            <img
              ...
              alt="Sethor"
            />
            <p className='text-[var(--letter-sub-color)]'>© 2023 Broad. All Rights Reserved.</p>
